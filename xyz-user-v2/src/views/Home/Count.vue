<template>
  ...
  <div class="container">
    <div class="px-4 py-4 mx-auto">
      <div
        class="grid sm:h-24 sm:grid-flow-row sm:gap-4 sm:grid-cols-3 grid-cols-1 md:grid-cols-4"
      >
        <div
          class="-intro-x shadow-lg flex flex-col justify-center bg-white border border-gray-300 rounded"
        >
